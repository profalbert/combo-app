...
export const chatReducer = (
  ...
  switch (action.type) {
    case 'CHAT_INITIALIZED_PERSON': {
      ...
      let isAutorizatedPerson =
        Object.values(person).length === Object.keys(person).length &&
        Object.values(person).every((item) => item)
      return {
        ...state,
        person: {
          ...person,
